...
def cmd_login(args: argparse.Namespace) -> int:
    ...
    with _http() as client:
        ...
        if not args.callback_url:
            ...
            print()
            print("1. Open this URL in a browser and sign in to your LG account:")
            print()
            ...
            print()
            print("Tokens print as env exports (includes THINQ_CLIENT_ID — keep it).")
            print("Do not commit them. Prefer a bot secret card or a gitignored .env.")
            return 0
